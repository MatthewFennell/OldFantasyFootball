...
import uk.co.pampoomio.fennell.server.auth.JwtTokenProvider;
import uk.co.pampoomio.fennell.server.auth.TokenPair;
import uk.co.pampoomio.fennell.server.repos.ApplicationUserRepo;
import uk.co.pampoomio.fennell.server.repos.LeagueRepo;
import uk.co.pampoomio.fennell.server.repos.WeeklyTeamRepo;
...
import uk.co.pampoomio.fennell.server.repos.documents.UserAuthority;
import uk.co.pampoomio.fennell.server.repos.documents.UsersWeeklyTeam;
import uk.co.pampoomio.fennell.server.routers.dto.LoginDTO;
import uk.co.pampoomio.fennell.server.routers.dto.RegisterDTO;
import uk.co.pampoomio.fennell.server.routers.dto.TokenReturnDTO;
import uk.co.pampoomio.fennell.server.routers.dto.UserReturnDTO;
