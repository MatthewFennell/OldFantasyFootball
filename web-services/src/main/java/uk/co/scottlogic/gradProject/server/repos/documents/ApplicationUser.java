...
public class ApplicationUser implements UserDetails, Serializable {
    ...
    public void savePassword(String password) {
        if (!password.matches(PASSWORD_PATTERN)) {
            throw new IllegalArgumentException("Password must be between 6 and 31 alphanumeric characters, including at least 1 number");
        }
    ...
    public void setTeamName(String teamName) {
        ...
        for (String PROFANITY : PROFANITIES) {
            if (teamName.toLowerCase().contains(PROFANITY)) {
                throw new IllegalArgumentException("No profanities plz");
            }
        }
