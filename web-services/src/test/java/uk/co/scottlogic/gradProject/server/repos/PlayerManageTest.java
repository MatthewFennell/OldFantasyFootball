...
public class PlayerManageTest {
    ...
    public void makePlayerForValidTeam(){
        ...
        playerManager.makePlayer(collegeTeam, Player.Position.DEFENDER, 0, "firstname", "surname");
    }

    @Test(expected = IllegalArgumentException.class)
    public void makePlayerForInvalidTeam(){
        when(teamRepo.findById(any())).thenReturn(Optional.empty());
        playerManager.makePlayer(new CollegeTeam(), Player.Position.DEFENDER, 0, "firstname", "surname");
    }
    ...
    public void findPointsForPlayerInAWeek(){
        ...
        Player player = new Player(collegeTeam, Player.Position.ATTACKER, 10, "firstname", "surname");
    ...
    public void filterGoalkeepersReturnsOnlyKeepers(){
        ...
        Player p1 = new Player(collegeTeam, Player.Position.GOALKEEPER, 10, "firstname", "surname");
